      ...
      <Masonry className={"row my-gallery-class"} elementType={"div"}>
        ...
        >
          <div className="card-image-1">
            ...
            <img src="./img/gallery/antudy.png" alt="gallery" />
          </div>
        </div>
        <div
          className="col-lg-4 image-element-class de_modal de_modal"
                ...
                <div className="col-lg-4 de_project-info">
                  ...
                  <div className="de_project-details">
                    ...
                    <div className="d-field">
                      ...
                      <span>
                        <a
                          href="https://www.github.com/antudy"
                          target="_blank"
                          rel="noreferrer"
                        >
                          www.github.com/antudy
                        </a>
                      </span>
                    </div>
                  </div>
                  <div className="spacer-30"></div>
                  <p>React Native를 이용해 스터디 관리 앱을 만들어봄.</p>
                  <p>제4회 스마트 AI SW경진대회 우수상 수상</p>
                </div>
              </div>
            </div>
          </div>
